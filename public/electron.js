...
// Determine Ollama log file path (Windows)
...
function tailFile(filePath, numLines = 200) {
  return new Promise((resolve, reject) => {
    fs.stat(filePath, (err, stats) => {
      ...
      const bufferSize = Math.min(stats.size, 1024 * 50); // read up to 50KB
...
// Watch file for changes and emit new lines
...
// Send new log lines to renderer
